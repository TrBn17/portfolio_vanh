    ...
    <section className="relative flex min-h-screen items-center overflow-hidden bg-brand-black">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-32 grid lg:grid-cols-2 gap-12 items-center">
        <div className="hero-enter hero-enter-delay-1">
          <div className="inline-block border border-brand-red/80 bg-white/5 px-3 py-1 mb-6 backdrop-blur-sm">
          ...
          <div className="w-16 h-1 bg-brand-red mb-6 hero-enter hero-enter-delay-2" />
          ...
          <div className="hero-enter hero-enter-delay-4 flex flex-wrap gap-4">
            <a
              href="#experience"
              className="bg-brand-red text-white px-8 py-3 text-sm font-semibold transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:text-brand-black"
            >
              View Experience
            </a>
            <a
              href="#campaigns"
              className="border border-neutral-600 text-white px-8 py-3 text-sm font-semibold transition-all duration-300 hover:-translate-y-1 hover:border-white"
            >
              See Campaigns
            </a>
            <a
              ...
              className="border border-neutral-600 text-white px-8 py-3 text-sm font-semibold transition-all duration-300 hover:-translate-y-1 hover:border-white flex items-center gap-2"
            >
        ...
        <div className="relative flex justify-center lg:justify-end hero-enter hero-enter-delay-3">
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-brand-red shadow-[0_40px_120px_rgba(200,16,46,0.22)]">
              <Image
            ...
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-brand-red text-white text-xs font-semibold px-4 py-1.5 whitespace-nowrap shadow-lg hero-enter hero-enter-delay-4">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-neutral-500 pointer-events-none hero-enter hero-enter-delay-4">
